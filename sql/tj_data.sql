...
CREATE TABLE `course_profile`  (
  ...
  `sex_label` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '访问用户的性别标签',
...
CREATE TABLE `tab_dau_range`  (
  `id` bigint NOT NULL COMMENT '主键 ID',
  `dau_rang` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '活跃数区间',
